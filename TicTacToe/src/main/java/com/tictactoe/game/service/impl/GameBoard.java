...
public class GameBoard {
	...
	private static final int TOTAL_POSITIONS_ON_BOARD = 9;
	...
	public boolean isLeftToRightDiagonalOccupiedBySamePlayer() {
		if (getPlayerInPosition(Position.ONE) != EMPTY_POSITION_ON_BOARD) {
	...
	public boolean isRightToLeftDiagonalOccupiedBySamePlayer() {
		if (getPlayerInPosition(Position.THREE) != EMPTY_POSITION_ON_BOARD) {
	...
	public boolean isAnyOfTwoDiagonalOccupiedBySamePlayer() {
		return isLeftToRightDiagonalOccupiedBySamePlayer() || isRightToLeftDiagonalOccupiedBySamePlayer();
	}
